...
/**
 * Oggetto cassa di munizioni, alla raccolta aumenta di 5 le munizioni disponibili alla Ball
 */
public class Munizioni extends PowerUp {
    ...
    /**
     * Alla raccolta, aumenta di 5 le munizioni della Ball
     * @param ball Ball che ha raccolto l'oggetto
     */
    @Override
