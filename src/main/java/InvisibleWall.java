...
/**
 * Speciale ground invisibile che uccide la Ball al tocco. Usato come limite inferiore dei livelli
 */
public class InvisibleWall extends Ground{

    boolean kills; //Determina se deve uccidere la Ball o meno
    /**
    ...
    /**
     * Setta la vita della Ball che lo tocca a 0.
     * @param ball Ball che lo tocca
     */
